...
def normalize_current_glaze_claims(text: str) -> str:
    replacements = (
        ...
        ("V1.4.0 is consumer-eligible", "V1.4.1 is consumer-eligible"),
        ("css/glaze-v1.4.0.css", "css/glaze-v1.4.1.css"),
        ("js/glaze-v1.4.0.mjs", "js/glaze-v1.4.1.mjs"),
        ("design-system version 1.3.0", "design-system version 1.4.1"),
        ("Glaze source: 84cb3db4884042f0fa25ed6d475a127fb110f596", "Glaze source: 4fab9da0fad2e5c974e0e66ec88632c61745751c"),
        ...
        ("This source targets GLAZE UI 1.4.0 at canonical revision <code>84cb3db4884042f0fa25ed6d475a127fb110f596</code>.", "This mounted publication targets GLAZE UI 1.4.1 at canonical revision <code>4fab9da0fad2e5c974e0e66ec88632c61745751c</code>."),
        ...
        ("This Security Center revision targets Glaze UI <code>1.3.0</code> at canonical Glaze revision <code>8354308445da9ac35ced2b37a7f503a08a0aaf72</code>.", "This Security Center publication targets Glaze UI <code>1.4.1</code> at canonical Glaze revision <code>4fab9da0fad2e5c974e0e66ec88632c61745751c</code>."),
        ("Version 1.3.0 is the current Official Stable source target", "Version 1.4.1 is the current Official Stable source target"),
        ("<span>GLAZE UI V1.3</span>", "<span>GLAZE UI V1.4.1</span>"),
        ...
        ("current Stable 1.4.0 design", "current Stable 1.4.1 design"),
...
def verify_publication(root: Path, entry: dict, entries: list[dict], origin: str) -> None:
    ...
    stale_current_markers = (
        ...
        "targets GLAZE UI 1.3.0",
        "targets GLAZE UI 1.4.0",
        "targets Glaze UI <code>1.3.0</code>",
        "V1.4.0 is consumer-eligible",
        "css/glaze-v1.4.0.css",
        "js/glaze-v1.4.0.mjs",
        "current Stable 1.4.0 design",
        "Version 1.3.0 is the current Official Stable source target",
