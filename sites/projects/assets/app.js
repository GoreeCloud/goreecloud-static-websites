...
{name:'Glaze UI',repo:'goreecloud-glaze-ui',category:'Shared Foundations',model:'Design system · Official Stable 1.3.0',kind:'Foundation',status:'1.3.0 current Official Stable · Facet identity approved',role:'GoreeCloud Design Center and shared design-system authority for GLAZE UI V1.3 — Adaptive Resonance across supported GoreeCloud surfaces. V1.3 is consumer-eligible, but downstream conformance, rendered accessibility, performance, rollback, and production acceptance remain repository-local and evidence-backed.',visibility:'Public',icon:'/assets/glaze-ui-mark.svg',url:'https://design.goreecloud.com/'},
...
{name:'Wardveil Security',repo:'goreecloud-wardveil-security',category:'Shared Foundations',model:'Security identity',kind:'Foundation',status:'Foundation 0.9 active · production runtime acceptance separate',role:'Platform-wide security and protection authority with evidence-backed trust, policy, protection, detection, scanning, quarantine, response, and audit foundations. Production runtime acceptance remains separate and fail closed.',visibility:'Private',icon:'/assets/wardveil-security-icon.svg',url:'https://security.goreecloud.com/'},
