const suitePortfolioGroups=Object.freeze({
  ...
  'Platform & operations':['GoreeCloud Manager','GoreeCloud App Store','GoreeCloud Identity','GoreeVault','GoreeCloud Backup','GoreeCloud Network','GoreeCloud DNS','GoreeCloud Gateway','GoreeCloud Notify','GoreeCloud Monitor','GoreeCloud Changelogs'],
...
const currentSuiteAdditions=[
  ...
  {name:'GoreeVault',repo:'goreecloud-vault-server',category:'Personal Data & Security',model:'GoreeCloud credential-management product',kind:'Application',status:'Active development',role:'User-facing password, credential, secret, secure-record, and sensitive-information product. The canonical GoreeCloud Vault Server remains its separately governed server component.',visibility:'Public'},
